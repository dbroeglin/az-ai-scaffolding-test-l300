metadata name = 'aigbb-scaffolding-test-l300'
metadata description = 'Deploys the infrastructure for AI GBB scaffolding tool test'
...
var tags = union(
  {
    ...
    solution: 'aigbb-scaffolding-test-l300'
  },
  extraTags
)
