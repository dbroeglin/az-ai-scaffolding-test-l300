metadata name = 'az-ai-scaffolding-test-l300'
metadata description = 'Deploys the infrastructure for Az AI scaffolding tool test'
...
var tags = union(
  {
    ...
    solution: 'az-ai-scaffolding-test-l300'
  },
  extraTags
)
